...
프로젝트나 학교 시험, 과제 등 중요한 일을 앞두고 집중이 필요할 때 위치를 기반으로 당신의 집중 시간을 기록하여 어디에서 얼마나 어떤 일들을 해냈는지, 어느 장소에서 당신의 집중력이 최대치를 발휘하는지를 발견하고 기록합니다.

### 🛠 Frontend Tech Stack

<img src="https://img.shields.io/badge/javascript-%23F7DF1E.svg?&style=for-the-badge&logo=javascript&logoColor=white" /> <img src="https://img.shields.io/badge/html5-%23E34F26.svg?&style=for-the-badge&logo=html5&logoColor=white" />
...
### 📝 Todo
#### Todo(할 일) 추가하기
할 일을 적고 enter 혹은 '+ 추가' 버튼으로 할일 추가 성공적으로 반영된 경우 SSE 실시간 알림을 띄워 정상적으로 저장된 걸 확인할 수 있습니다.
![Image](https://github.com/user-attachments/assets/51fe6284-94a1-4907-8571-9c96b1c93cb9)

#### Todo(할 일) 완료
할 일 완료 체크시 3초 지연시간을 두고 완료 상태를 반영하여 SSE 알림 보내도록 구현, 
그 지연 시간동안 사용자가 다시 할 일 완료를 취소하는 경우 완료 상태가 DB에 반영되지 않습니다.
